...
@section('content')
    ...
    <section class="max-w-[1440px] mx-auto px-6 lg:px-[80px] mb-10">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            @foreach ([
                ['label' => 'Total Unit',      'value' => '251', 'color' => 'bg-[#393939] text-white'],
                ['label' => 'Unit Tersedia',   'value' => '209', 'color' => 'bg-[#D1FAE5] text-[#065F46]'],
                ['label' => 'Unit Terjual',    'value' => '42',  'color' => 'bg-[#FEE2E2] text-[#991B1B]'],
                ['label' => 'Unit Booking',    'value' => '0',   'color' => 'bg-[#FEF3C7] text-[#92400E]'],
            ] as $s)
