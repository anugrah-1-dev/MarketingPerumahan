    ...
    <nav id="mainNav">
        <div class="max-w-[1440px] mx-auto px-6 lg:px-[80px] flex items-center justify-between py-4">
            ...
            <div class="hidden lg:flex items-center">
                <a href="{{ route('landing') }}#tentang" class="nav-pill nav-cta">Hubungi Kami</a>
            </div>
        ...
        <div id="drawerPanel">
            ...
            <div class="px-6 py-5 border-t border-gray-100">
                <a href="{{ route('landing') }}#tentang"
                   class="block text-center bg-[#0B5E41] text-white font-semibold text-sm py-3 rounded-xl hover:bg-[#094d36] transition">
                    Hubungi Kami
                </a>
            </div>
        </div>
