...
<body class="min-h-screen">
    ...
    <nav id="mainNav">
        <div class="max-w-[1440px] mx-auto px-4 lg:pl-8 lg:pr-[80px] flex items-center justify-between py-4">
            ...
            {{-- Navigasi Desktop (flex-1 + justify-center agar benar-benar di tengah) --}}
            @php
            ...
            @endphp
            <div class="hidden lg:flex justify-end ml-auto items-center gap-7 flex-1">
    ...
    <script>
    (function () {
        // -- Navbar mengikuti posisi scroll -------------------
        ...
        // Tutup drawer saat salah satu tautan di dalamnya diklik
    ...
    <footer id="tentang" class="bg-[#393939] text-white mt-20">
        <div class="max-w-[1440px] mx-auto px-6 lg:px-[80px] py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <img src="{{ asset('assets/landing/fotokawasan_v2.jpeg') }}"
