...
@section('content')
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- Status toggle --}}
                            <td>
                                <form method="POST" action="{{ route('manager.social-media.toggle', $item->id) }}" style="display:inline;">
                                    @csrf @method('PATCH')
                            ...
                            <td>
                                <div style="display:flex;gap:5px;">
                                    ...
                                    <form method="POST" action="{{ route('manager.social-media.destroy', $item->id) }}"
    ...
    <div id="smModal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9000;align-items:center;justify-content:center;padding:1rem;">
        <div style="background:#fff;border-radius:16px;width:100%;max-width:560px;max-height:92vh;overflow-y:auto;padding:2rem;">
            ...
            <form id="smForm" method="POST" action="{{ route('manager.social-media.store') }}" enctype="multipart/form-data">
                @csrf
    ...
    <script>
        ...
        var baseStore = "{{ route('manager.social-media.store') }}";
        ...
        function openEditModal(item) {
            ...
            smForm.action  = '/manager/social-media/' + item.id;
