    ...
    <div class="unit-table-wrap">
        <table class="unit-table">
            ...
            <tbody id="unitTableBody">
                ...
                @empty
                <tr><td colspan="8" class="unit-empty">Belum ada data unit.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
...
<div id="modal-tambah" class="unit-modal-overlay">
    <div class="unit-modal">
        ...
        <form method="POST" action="{{ route('affiliate.units.store') }}">
            @csrf
...
function unitOpenEdit(u) {
    ...
    document.getElementById('form-edit').action  = '/affiliate/units/' + u.id;
    unitOpenModal('modal-edit');
}
function unitOpenDel(id, nama) {
    document.getElementById('del-unit-name').textContent = nama;
    document.getElementById('form-hapus').action = '/affiliate/units/' + id;
