...
@section('title', 'Pengisian Data Klien - Bukit Shangrilla Asri')
...
.form-header h1 { font-size: 28px; font-weight: 700; color: #222; }
.form-header p  { color: #888; font-size: 14px; margin-top: 4px; }
...
<div class="form-wrap">
    ...
    <div class="form-card" style="max-width:560px; text-align:center;">
        ...
        <div class="form-actions" style="justify-content:center; margin-top:24px;">
            ...
            <a href="{{ route('affiliate.leads') }}" class="btn-back" style="text-decoration:none;">Lihat Leads</a>
        </div>
    </div>
