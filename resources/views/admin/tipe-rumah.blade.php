...
{{-- ====================== MODAL TAMBAH ====================== --}}
<div id="modal-tambah" class="tr-modal-overlay" style="z-index:9999">
    <div class="tr-modal-box">
        ...
        <form method="POST" action="{{ route('admin.tipe-rumah.store') }}" enctype="multipart/form-data">
            @csrf
...
{{-- ====================== MODAL EDIT ====================== --}}
<div id="modal-edit" class="tr-modal-overlay" style="z-index:9999">
    <div class="tr-modal-box">
        <div class="tr-modal-header">
            <h3>
                <svg xmlns="http://www.w3.org/2000/svg" style="display:inline;width:18px;height:18px;vertical-align:-3px;margin-right:6px;color:#2563eb" fill="none" viewBox="0 0 24 24" stroke="currentColor">
