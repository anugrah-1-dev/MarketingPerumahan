...
@section('content')
        ...
        <div class="bg-white p-4 lg:p-6 rounded-[20px] shadow-sm">
            ...
            <div class="mt-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-bold text-gray-800 text-lg">Kantor Pemasaran Bukit Shangrilla Asri</h4>
    ...
    {{-- ================================================================
     POPUP FORM - Konfirmasi sebelum membuka WhatsApp
     ================================================================ --}}
    <div id="wa-contact-modal"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 relative" onclick="event.stopPropagation()">
            ...
            <p class="text-gray-600 text-sm mb-5">Anda akan diarahkan ke WhatsApp untuk berkonsultasi langsung.</p>

            {{-- Submit --}}
            <button type="button" onclick="submitWaPopup()"
                    class="w-full bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold py-3 rounded-xl
